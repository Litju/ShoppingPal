...
- Medusa remains the only cart/order authority.
...
Catalog descriptions are wrapped as untrusted data and cannot authorize tools. Checkout is approval-gated and currently reports Medusa's missing payment setup rather than fabricating order success.
